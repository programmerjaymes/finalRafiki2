...
export default function Hero() {
  return (
    ...
    >
      ...
      <motion.div 
        className="absolute -bottom-32 -left-32 w-96 h-96 rounded-full bg-gradient-to-r from-primary-light/30 to-secondary/20 blur-3xl"
        style={{
      ...
      <motion.div 
        className="absolute -top-32 -right-32 w-96 h-96 rounded-full bg-gradient-to-r from-secondary/30 to-secondary-dark/30 blur-3xl"
        style={{
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-28 md:py-36 relative z-10">
        <div className="flex flex-col md:flex-row items-center justify-between">
          ...
          >
            ...
            >
              <div className="flex -space-x-2">
                {[1, 2, 3, 4].map((item) => (
                  <div key={item} className="w-10 h-10 rounded-full border-2 border-white overflow-hidden" style={{ backgroundColor: '#d1ac0b', borderColor: 'white' }}>
          ...
          >
            <div className="w-full max-w-md h-80 md:h-96 relative bg-white/10 dark:bg-white/5 backdrop-blur-lg rounded-xl p-1 shadow-2xl">
                  ...
                  <div className="flex-1 grid grid-cols-2 gap-4">
                    {[1, 2, 3, 4].map((item) => (
                      <div key={item} className="bg-white/10 rounded-lg overflow-hidden shadow-sm">
                        <div className={`h-24 ${styles.gradientBg} opacity-20`}></div>
                        <div className="p-2">
      ...
      {/* Wave divider */}
      <div className="absolute bottom-0 left-0 right-0 h-16 text-gray-50 dark:text-gray-900">
